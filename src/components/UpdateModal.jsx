...
const UpdateModal = ({
  ...
  return (
    <>
      <ToastContainer />
      <div className="w-full h-screen bg-black/20 dark:bg-black/100 fixed top-16 left-0 flex justify-center items-center">
        <div className="w-1/3 bg-slate-50 dark:bg-[#1b1d1e] border dark:border-[#363b3d] shadow-xl -translate-y-8 text-slate-600 rounded-md py-3 px-4 box-border">
