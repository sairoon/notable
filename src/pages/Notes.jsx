        ...
        <div className="w-full min-h-screen py-16 dark:bg-[#181a1b] dark:text-[#b0aa9f] ">
          <div className="container">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-500 dark:text-[#b0aa9f]">
                All Notes
              </h1>
                ...
                >
                  ...
                  <div className="mt-2 flex justify-end">
                    <div className="relative group">
                      <button
                        className="border-2 border-cyan-600 dark:border-cyan-400 dark:text-cyan-400 hover:font-normal text-cyan-600 hover:text-white px-2 py-2 rounded-md hover:bg-cyan-700 transition ease-out active:scale-90"
                    ...
                    <div className="relative group">
                      <button
                        className="border-2 dark:border-red-600 bg-red-600 text-white px-2 py-2 rounded-md ms-2 hover:bg-red-700 transition ease-out active:scale-90"
